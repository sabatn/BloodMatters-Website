    ...
    if (!$result) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
          ...
          <!-- <td><a href="update_page_1.php?ID=<?php echo $row["Type_ID"]; ?>" class="btn btn-success">Update</a></td>
          <td><a href="delete_page.php?ID=<?php echo $row["Type_ID"]; ?>"class="btn btn-danger">Delete</a></td> -->
